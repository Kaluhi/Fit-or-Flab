...
public class DetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (exerciseTitle.equalsIgnoreCase(MainActivity.EXERCISE_WEIGHTS)){
            exerciseImage.setImageDrawable(getResources().getDrawable(R.drawable.weight,getApplication().getTheme()));
            ...
            exerciseImage.setImageDrawable(getResources().getDrawable(R.drawable.cardiogram,getApplication().getTheme()));
